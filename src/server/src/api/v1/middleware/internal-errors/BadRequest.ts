...
const ERROR_MESSAGES = {
  ...
  BAD_NONCE: new ErrorMessage('Invalid nonce'),
  ...
  MISSING_NONCE: new ErrorMessage('Missing nonce'),
  ...
  OLD_NONCE: new ErrorMessage('Expired nonce'),
  ...
  UNVERIFIED_ALIAS: new ErrorMessage<{alias: string}>('Please verify this {alias} before logging in'),
};

type BadRequestOptions = {
  code: number;
  statusCode: number;
  message: string;
};

export class BadRequest extends InternalError implements BadRequestOptions {
